...
def eval_llm(model, tokenizer, task_list=["boolq","piqa","hellaswag","winogrande","arc_challenge","arc_easy","openbookqa"], num_fewshot=0):
    ...
    results = evaluator.simple_evaluate(
        ...
        model_args="pretrained=baffo32/decapoda-research-llama-7B-hf",
        tasks=task_names,
...
def main(args):
    ...
    if True:
        task_list_dict = {0: ["boolq", "piqa","hellaswag","winogrande", "arc_easy","arc_challenge"]}
        # task_list_dict = {0: ["wikitext"]}
        accelerate=False 
        for num_shot in [0]:
